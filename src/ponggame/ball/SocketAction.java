 ...
 // public SocketAction( JApplet a_inp ){
  ...
  //  super("SocketAction");
	...
	// Connection to host port 1234
	  ...
	  System.out.println("Ball active on"+PORTNUM);
	  // Create the selector
	  ...
	  try {
		  ...
		  System.out.println("key ballKey is"+key);
				...
				//  System.out.println("key client is"+key);
				 // channel.register(selector, SelectionKey.OP_READ);
				  ...
				  if (key.isConnectable()) {
					  ...
					  System.out.println("key2 ball is now readable is"+key2);
					  // Connection OK
...
public void run() {
  ...
  public void send(String s) {
	//   System.out.println("sent by Ball "+s+"\n");
	  ByteBuffer buffer = null;
	  buffer = 
		  ByteBuffer.wrap(
  ...
  public String receive() throws IOException {
	  ...
	  {
	  System.out.println("receive Ball converted"+charBuffer.toString()+"\n");
	  }
	  buffer.clear();
